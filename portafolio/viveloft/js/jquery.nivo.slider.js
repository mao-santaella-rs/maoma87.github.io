...
(function($) {
	...
	$.fn.nivoSlider = function(options) {
		...
		return this.each(function() {
			...
			//slide_desc
			$('#slide_desc').html(vars.currentImage.parent().children('.desc').html());
			...
			slider.bind('nivo:animFinished', function(){ 
				...
				//slide_desc
					$('#slide_desc').html(vars.currentImage.parent().children('.desc').html());
					//$("#slide_desc").animate({'top': "260px"}, 250, function() {
					$(".titles").animate({'top': "0px", 'easing':"swing"}, 150);														 
					$(".proj_cat").animate({'right': "0px", 'easing':"swing"}, 150);
					//});
			});
		});
		...
		function nivoRun(slider, kids, settings, nudge){
			...
			//settings.beforeChange.call(this);
					...
					$(".titles").animate({'top': "90px", 'easing':"swing"}, 150);	
					$(".proj_cat").animate({'right': "-205px", 'easing':"swing"}, 150);//, function () {
						 //$("#slide_desc").animate({'top': "350px"}, 250);
					//});
